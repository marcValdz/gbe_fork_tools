...
def generate_cdx_ini(base_out_dir: str, appid: int, user_id3: str, username: str, dlc: list[tuple[int, str]], achs: list[dict]) -> None:
    ...
    formatted_ini = __cdx_ini.format(cdx_app_id=appid, cdx_id3=user_id3, cdx_name=username, cdx_dlc_list="\n".join(dlc_list), cdx_ach_list="\n".join(achs_list))
